...
const ViewReportBySingleDivision = () => {
    strings.setLanguage(
    ...
    const getReportByDivision = () => {
        let config = {
            method: "get",
            url: BASE.BASE_API_URL + END_POINT.GET_REPORT_BY_SINGLE_DIVISION,
            headers: {
    ...
    return (
        <div className="report-container">
            ...
            <h5 className="report-header">{strings.todays_report}</h5>
        </div>
    );
};

export default ViewReportBySingleDivision;
